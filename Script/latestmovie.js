function latest(event) {
    ...
    fetch("https://api.themoviedb.org/3/movie/upcoming?api_key=a8d2cf66dd744dfbd1ed46c862cb9337&language=en-US&page="+i, {
        "method": "GET",
        ...
        .then(data => {
            document.getElementById('upcoming_movies').innerHTML = 'Upcoming Movies';
            var divelement = document.getElementById('upcoming_movies_results');
            ...
            for (i in data.results) {
                ...
                if(((dateArray[0]>yyyy) || (dateArray[1]>mm && dateArray[0]==yyyy ) || (dateArray[2]>dd && dateArray[1]==mm && dateArray[0]==yyyy)) && data.results[i].poster_path!=null && count!=0){
